...
CREATE TABLE client_epargne (
    ...
    pourcentage INT,
    FOREIGN KEY (numero) REFERENCES user (numero)
);
...
CREATE TABLE promotion(
    id_op INT,
    pourcentage INT ,
    FOREIGN KEY (id_op) REFERENCES operator(id)
);
-- =========================================================
...
INSERT INTO
    tranche (id, inf, sup, frais, id_type)
VALUES (1, 0, NULL, 0, 1),
    (2, 0, NULL, 500, 2),
    (3, 0, NULL, 250, 3);
...
VALUES (1, 2, 0.0150),
    (2, 1, 0.0150), -- Orange <-> Telma
    (1, 3, 0.0180),
    (3, 1, 0.0180), -- Orange <-> Airtel
    (1, 4, 0.0200),
    (4, 1, 0.0200), -- Orange <-> Blueline
    (1, 5, 0.0200),
    (5, 1, 0.0100), -- Orange <-> 069
    (2, 3, 0.0120),
    (3, 2, 0.0120), -- Telma <-> Airtel
    (2, 4, 0.0150),
    (4, 2, 0.0150), -- Telma <-> Blueline
    (2, 5, 0.0200),
    (5, 2, 0.0100), -- Telma <-> 069
    (3, 4, 0.0150),
    (4, 3, 0.0150), -- Airtel <-> Blueline
    (3, 5, 0.0200),
    (5, 3, 0.0100), -- Airtel <-> 069
    (4, 5, 0.0200),
    (5, 4, 0.0100);
-- Blueline <-> 069
...
INSERT INTO
    mvt_details (id, id_mvt, id_tranche)
VALUES (1, 1, 1),
    (2, 2, 2),
    (3, 3, 3),
    (4, 4, 1),
...
INSERT INTO
    mvt_commission (id, id_mvt, montant, instant)
VALUES (
        1,
        11,
        2000.00,
